...
**절주숲**은 **[2026 대학생 절주 서포터즈] 주(酒)도권** 팀이 만든 프로젝트로, 
음주폐해를 예방하고 건강한 절주 문화를 조성하기 위해 기획되었습니다.

방학이 되면 약속과 술자리가 자연스럽게 늘어나는 대학생들이 매일의 음주 여부를 기록하고, 
스스로 세운 목표와 비교해보며 **"내가 술을 마시는 이유"를 되돌아보는 시간**을 가질 수 있도록 만들었습니다.
...
주(酒)를 이기는 주(主), 우리가 잡는 주도권!
음주폐해 예방 및 절주 문화 조성을 선도하는 인제대학교 주(酒)도권 팀입니다.
